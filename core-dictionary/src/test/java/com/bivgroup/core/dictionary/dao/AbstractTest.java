...
public abstract class AbstractTest {
    ...
    protected DataSource getDataSource(String className, String url, String user_name, String password) throws DictionaryException {
        DataSource dataSource;
        try {
    ...
    abstract void init() throws DatabaseUnitException, SQLException, MalformedURLException;
    ...
    @BeforeClass
    public void setUp(@org.testng.annotations.Optional("org.h2.jdbcx.JdbcDataSource") String className, @org.testng.annotations.Optional("jdbc:h2:file:C:/projects/core/core-dictionary/demo;MV_STORE=FALSE;MVCC=FALSE") String url, @org.testng.annotations.Optional String shema_name, @org.testng.annotations.Optional("sa") String user_name, @org.testng.annotations.Optional String password) throws DictionaryException, SQLException, DatabaseUnitException, MalformedURLException {
        className = "oracle.jdbc.pool.OracleDataSource";
        url = "jdbc:oracle:thin:@192.168.100.159:1521:ORCD";
        shema_name =   "SBER_DEV_03";
        user_name = "SBER_DEV_03";
        password = "1";
